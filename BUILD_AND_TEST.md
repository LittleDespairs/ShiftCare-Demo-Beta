...
```text
ShiftCare_0.20.2_beta.spec
```

Build command:

```powershell
.\.venv\Scripts\pyinstaller.exe ShiftCare_0.20.2_beta.spec
```
...
```text
dist\installer\ShiftCare_Setup_0.20.2-beta.exe
dist\installer\ShiftCare_Demo_Setup_0.20.2-beta.exe
```
