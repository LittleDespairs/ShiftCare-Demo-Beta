...
class ApiRegressionTests(unittest.TestCase):
    ...
    def test_service_worker_caches_current_employee_portal_assets(self):
        ...
        self.assertIn("20260618-employee-schedule-mobile", service_worker_js)
        self.assertIn("/login", service_worker_js)
        self.assertIn("/static/css/auth.css?v=0.20.3_beta-portal-entry-operations-ui", service_worker_js)
        self.assertIn("/static/js/auth.js?v=0.20.3_beta-portal-entry-employee-mode", service_worker_js)
        self.assertIn("/static/js/schedule.js?v=0.20.3_beta-employee-schedule-mobile", service_worker_js)
