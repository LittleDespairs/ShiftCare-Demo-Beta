...
class ApiRegressionTests(unittest.TestCase):
    ...
    def test_service_worker_caches_current_employee_portal_assets(self):
        ...
        self.assertIn("20260618-employee-portal-polish", service_worker_js)
        ...
        self.assertIn("/static/js/schedule.js?v=0.20.3_beta-employee-schedule-readable", service_worker_js)
