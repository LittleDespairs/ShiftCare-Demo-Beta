(function () {
    const translations = {
        en: {
            ...
            org_cloud_checking_snapshot: "Checking the cloud organization before linking...",
            org_cloud_protocol_update: "Update the cloud service before linking this organization.",
            org_cloud_linked_pending: "Connected. Recent local changes are waiting to synchronize.",
        ...
        ru: {
            ...
            org_cloud_checking_snapshot: "Проверка облачной организации перед подключением...",
            org_cloud_protocol_update: "Обновите облачный сервис перед подключением организации.",
            org_cloud_linked_pending: "Подключено. Последние локальные изменения ожидают синхронизации.",
        ...
        he: {
            ...
            org_cloud_checking_snapshot: "בודק את ארגון הענן לפני החיבור...",
            org_cloud_protocol_update: "עדכן את שירות הענן לפני חיבור הארגון.",
            org_cloud_linked_pending: "מחובר. שינויים מקומיים אחרונים ממתינים לסנכרון.",
