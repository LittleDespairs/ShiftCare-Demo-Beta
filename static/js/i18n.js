...
const I18N_TRANSLATIONS = {
    en: {
        ...
        settings_license_demo_text: "Demo mode uses fictional seeded data. Generation and export are available, while production-only setup and destructive tools stay disabled.",
        ...
        demo_schedule_notice: "ShiftCare Demo uses fictional seeded data. Auto-generation and export are available; cleanup, backup, cloud sync, updates, and license activation are disabled.",
    ...
    ru: {
        ...
        settings_license_demo_text: "Демо-режим использует вымышленные тестовые данные. Генерация и экспорт доступны, а производственные настройки и опасные инструменты отключены.",
        ...
        demo_schedule_notice: "ShiftCare Demo использует вымышленные тестовые данные. Автогенерация и экспорт доступны; очистка, backup, cloud sync, обновления и активация лицензии отключены.",
    ...
    he: {
        ...
        settings_license_demo_text: "מצב ההדגמה משתמש בנתונים בדויים. יצירה אוטומטית וייצוא זמינים, וכלי ייצור מסוכנים נשארים מושבתים.",
        ...
        demo_schedule_notice: "ShiftCare Demo משתמש בנתונים בדויים. יצירה אוטומטית וייצוא זמינים; ניקוי, גיבוי, סנכרון ענן, עדכונים והפעלת רישיון מושבתים.",
