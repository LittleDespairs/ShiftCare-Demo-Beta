...
const I18N_TRANSLATIONS = {
    en: {
        ...
        nav_organization: "Personal account",
        ...
        home_title: "Operations home",
        home_subtitle: "Start with the next operational step, not another dashboard.",
        ...
        home_next_kicker: "Next step",
        home_next_loading_title: "Checking workspace",
        home_next_loading_text: "Reading employees, roles, templates, coverage rules, and this week's schedule.",
        home_next_action: "Open schedule",
        home_week_kicker: "Current week",
        home_week_title: "Working set",
        home_metric_position: "Primary position",
        home_metric_schedule_entries: "Scheduled shifts",
        home_metric_preferences: "Preferences",
        home_metric_coverage: "Coverage rules",
        home_primary_position_fallback: "No position yet",
        home_actions_title: "Operational shortcuts",
        home_ready_kicker: "Readiness",
        home_ready_title: "Workspace checklist",
        home_readiness_employees: "Employees",
        home_readiness_positions: "Positions",
        home_readiness_assignments: "Assignments",
        home_readiness_templates: "Shift templates",
        home_readiness_coverage: "Coverage rules",
        home_readiness_license: "License",
        home_status_ready: "Ready",
        home_status_attention: "Needs setup",
        home_status_unknown: "Unknown",
        home_org_kicker: "Workspace",
        home_org_title: "Operational status",
        home_org_users: "Active users",
        home_org_environment: "Environment",
        home_org_version: "Version",
        home_license_kicker: "License",
        home_license_title: "Access limits",
        home_license_status: "Status",
        home_license_usage: "Employees",
        home_auth_required_title: "Sign in to continue",
        home_auth_required_text: "The workspace is protected. Sign in before editing employees, positions, and schedules.",
        home_auth_required_action: "Open login",
        home_setup_auth_title: "Create organization access",
        home_setup_auth_text: "No active users are configured yet. Start by creating or authorizing an organization user.",
        home_setup_auth_action: "Set up access",
        home_setup_employees_title: "Add the care team",
        home_setup_employees_text: "The schedule needs employees before positions, preferences, and generation can be useful.",
        home_setup_employees_action: "Open employees",
        home_setup_positions_title: "Create positions",
        home_setup_positions_text: "Positions define where people can work and how the schedule is separated.",
        home_setup_positions_action: "Open settings",
        home_setup_assignments_title: "Assign people to positions",
        home_setup_assignments_text: "The generator ignores employees who are not linked to the selected position.",
        home_setup_assignments_action: "Open assignments",
        home_setup_templates_title: "Create shift templates",
        home_setup_templates_text: "Templates describe the real shift times used by manual editing and auto-generation.",
        home_setup_templates_action: "Open templates",
        home_setup_coverage_title: "Set coverage rules",
        home_setup_coverage_text: "Coverage rules tell the app how many employees are needed across the week.",
        home_setup_coverage_action: "Open coverage",
        home_setup_schedule_title: "Build this week's schedule",
        home_setup_schedule_text: "The setup is ready. Open the schedule page and fill the current week.",
        home_setup_schedule_action: "Open schedule",
        home_setup_review_title: "Review the current week",
        home_setup_review_text: "The workspace has live schedule data. Review coverage and employee preferences before sharing.",
        home_setup_review_action: "Review schedule",
        home_load_error_title: "Could not read workspace",
        home_load_error_text: "Refresh the page or open the schedule directly if the local API is still starting.",
        ...
        schedule_current_employee_badge: "You",
        shift_swap_section_label: "Shift swaps",
        shift_swap_panel_title: "Swap requests",
        shift_swap_title: "Request shift swap",
        shift_swap_source_label: "Your shift",
        shift_swap_request_button: "Request swap",
        shift_swap_short_button: "Swap",
        shift_swap_no_candidates: "No available shifts to request for swap.",
        shift_swap_pick_target: "Choose shift to request",
        shift_swap_already_pending: "already pending",
        shift_swap_status_pending_target: "Waiting for employee",
        shift_swap_status_pending_admin: "Waiting for administrator",
        shift_swap_status_approved: "Approved",
        shift_swap_status_rejected: "Rejected",
        shift_swap_status_cancelled: "Cancelled",
        shift_swap_accept: "Accept",
        shift_swap_reject: "Reject",
        shift_swap_cancel: "Cancel",
        shift_swap_approve: "Approve",
        shift_swap_created: "Shift swap request sent.",
        shift_swap_updated: "Shift swap request updated.",
        shift_swap_create_failed: "Could not create shift swap request.",
        shift_swap_update_failed: "Could not update shift swap request.",
        shift_swap_disabled: "Shift swap requests are disabled.",
        schedule_other_positions_label: "Other positions",
        schedule_delete_shift_btn: "Delete",
        schedule_edit_shift_time: "Edit time",
        schedule_time_btn: "Time",
        schedule_manual_time: "Manual time",
        schedule_reset_template_time: "Reset to template",
        ...
        confirm_impact_recurring_preferences: "Permanent wishes",
        ...
        msg_failed_save_shift_time: "Failed to save shift time.",
        msg_server_error_save_shift_time: "Server error while saving shift time.",
        ...
        generation_reason_cross_position_day: "same-day work with other positions is not allowed for one of the positions",
        ...
        employees_permanent_preferences_title: "Permanent wishes",
        employees_permanent_preferences_hint: "These optional rules are saved for the employee and applied every week.",
        employees_permanent_strict_title: "Strict wishes",
        employees_permanent_strict_text: "The generator must respect these wishes.",
        ...
        msg_failed_load_permanent_preferences: "Failed to load permanent wishes.",
        msg_server_error_load_permanent_preferences: "Server error while loading permanent wishes.",
        msg_failed_save_permanent_preferences: "Failed to save permanent wishes.",
        ...
        preferences_request_modal_intro: "Choose what this employee is asking for on the selected day.",
        preferences_request_type: "Request type",
        preferences_request_shift: "Request shift",
        preferences_request_shift_hint: "Prefer one specific shift.",
        preferences_exclude_shift: "Exclude shift",
        preferences_exclude_shift_hint: "Do not assign one specific shift.",
        preferences_day_off_hint: "Block work for this day.",
        preferences_vacation_hint: "Mark as unavailable because of vacation.",
        preferences_request_shift_category: "Shift",
        preferences_request_category_hint: "Pick the exact shift this request applies to.",
        preferences_morning_hint: "Day start",
        preferences_evening_hint: "Late day",
        preferences_night_hint: "Overnight",
        preferences_approval_title: "Extra request approvals",
        preferences_approval_text: "Employees can save requests for two days directly. Additional days wait for approval here.",
        preferences_approval_empty: "No extra requests are waiting for approval.",
        preferences_approve_request: "Approve",
        preferences_reject_request: "Reject",
        preferences_delete_request: "Delete",
        preferences_request_status_pending: "Pending approval",
        preferences_request_status_approved: "Approved",
        preferences_request_status_rejected: "Rejected",
        ...
        preferences_note_4: "Employees can save requests for two days directly; additional days require administrator approval.",
        ...
        msg_preference_change_saved_reload_failed: "The change was saved, but the list could not be refreshed:",
        msg_preference_deleted: "Preference cleared successfully.",
        msg_preference_request_pending_approval: "This request was sent for administrator approval.",
        msg_preference_request_approved: "Preference request approved.",
        msg_preference_request_rejected: "Preference request rejected.",
        msg_preference_request_deleted: "Preference request deleted.",
        ...
        msg_server_error_delete_preference_request: "Server error while deleting preference request.",
        msg_server_error_load_preference_requests: "Server error while loading preference requests.",
        departments_page_title: "Departments",
        departments_page_subtitle: "Separate teams, wards, and services before creating positions.",
        departments_default_name: "Main department",
        departments_form_title: "Department form",
        departments_form_subtitle: "Add wards or services so positions can be separated cleanly.",
        departments_name: "Department name",
        departments_name_placeholder: "Example: Ward 1",
        departments_description: "Description",
        departments_description_placeholder: "Optional note",
        departments_display_order: "Display order",
        departments_display_order_hint: "Lower numbers appear first in lists and selectors.",
        departments_is_active: "Active department",
        departments_add_button: "Add department",
        departments_update_button: "Update department",
        departments_reload_button: "Reload",
        departments_list_title: "Department list",
        departments_list_subtitle: "Departments available for positions and schedule grouping.",
        departments_table_id: "ID",
        departments_table_name: "Name",
        departments_table_description: "Description",
        departments_table_order: "Order",
        departments_table_active: "Active",
        departments_table_actions: "Actions",
        departments_empty_list: "No departments yet",
        departments_empty_state_title: "No departments yet",
        departments_empty_state_text: "Add a department before creating department-specific positions.",
        departments_msg_enter_name: "Please enter department name.",
        departments_msg_failed_load: "Failed to load departments.",
        departments_msg_server_error_load: "Server error while loading departments.",
        departments_msg_failed_save: "Failed to save department.",
        departments_msg_server_error_save: "Server error while saving department.",
        departments_msg_editing: "Editing department",
        departments_msg_confirm_delete: "Delete this department?",
        departments_delete_blocked_hint: "This department cannot be deleted until positions are moved or another department exists.",
        departments_msg_failed_delete: "Failed to delete department.",
        departments_msg_server_error_delete: "Server error while deleting department.",
        ...
        positions_select_department: "Select department",
        ...
        positions_allow_same_day_other_positions: "Allow same-day work with other positions",
        ...
        positions_table_department: "Department",
        positions_table_continuous: "Continuous coverage",
        positions_table_min_presence: "Minimum presence",
        positions_table_same_day_other_positions: "Other positions same day",
        ...
        msg_select_department: "Please select a department.",
        ...
        settings_tab_employee_portal: "Employee portal",
        settings_tab_employee_portal_text: "Employee schedule access",
        ...
        settings_departments_title: "Departments",
        settings_departments_text: "Separate wards, services, and teams before assigning positions.",
        ...
        settings_employee_portal_title: "Employee portal",
        settings_msg_loading_employee_portal: "Loading employee portal settings...",
        settings_msg_failed_load_employee_portal: "Failed to load employee portal settings. Try again.",
        settings_msg_saving_employee_portal: "Saving employee portal settings...",
        settings_employee_portal_text: "Control what employees can do in the employee portal.",
        settings_save_employee_portal: "Save employee portal settings",
        settings_shift_swap_enabled_title: "Employee shift swap requests",
        settings_shift_swap_enabled_text: "Allow employees to create new shift swap requests from the schedule.",
        settings_msg_failed_save_employee_portal: "Failed to save employee portal settings.",
        settings_msg_employee_portal_saved: "Employee portal settings saved.",
        ...
        settings_license_demo_text: "Demo mode uses fictional seeded data. Generation, export, and schedule cleanup are available, while production-only setup tools stay disabled.",
        ...
        demo_schedule_notice: "ShiftCare Demo uses fictional seeded data. Auto-generation, export, and schedule cleanup are available; backup, cloud sync, updates, and license activation are disabled.",
        ...
        updates_modal_title: "Update available",
        updates_modal_text: "A newer ShiftCare version is available.",
        updates_modal_current_version: "Current version",
        updates_modal_new_version: "New version",
        updates_modal_later: "Later",
        updates_modal_install: "Install update",
        updates_modal_installing_title: "Installing update",
        updates_modal_installing_text: "Downloading the update installer and preparing to close the app.",
        updates_modal_install_error_title: "Could not start update",
        updates_modal_install_started_title: "Update started",
        updates_modal_install_started_text: "The installer has started. ShiftCare will close shortly.",
        updates_changelog_title: "What's new",
        updates_changelog_text: "ShiftCare was updated. Main changes in this version:",
        updates_changelog_empty: "No short changelog was provided for this release.",
        ...
        coverage_max_daily_work: "Maximum daily work, minutes",
    ...
    ru: {
        ...
        nav_organization: "Личный кабинет",
        ...
        home_title: "Рабочий старт",
        home_subtitle: "Начинайте со следующего рабочего шага, а не с ещё одного дашборда.",
        ...
        home_next_kicker: "Следующий шаг",
        home_next_loading_title: "Проверяем рабочую область",
        home_next_loading_text: "Читаем сотрудников, должности, шаблоны, правила покрытия и расписание текущей недели.",
        home_next_action: "Открыть расписание",
        home_week_kicker: "Текущая неделя",
        home_week_title: "Рабочий набор",
        home_metric_position: "Основная должность",
        home_metric_schedule_entries: "Назначенные смены",
        home_metric_preferences: "Пожелания",
        home_metric_coverage: "Правила покрытия",
        home_primary_position_fallback: "Должности пока нет",
        home_actions_title: "Рабочие переходы",
        home_ready_kicker: "Готовность",
        home_ready_title: "Чеклист рабочей области",
        home_readiness_employees: "Сотрудники",
        home_readiness_positions: "Должности",
        home_readiness_assignments: "Назначения",
        home_readiness_templates: "Шаблоны смен",
        home_readiness_coverage: "Правила покрытия",
        home_readiness_license: "Лицензия",
        home_status_ready: "Готово",
        home_status_attention: "Нужно настроить",
        home_status_unknown: "Неизвестно",
        home_org_kicker: "Рабочая область",
        home_org_title: "Рабочее состояние",
        home_org_users: "Активные пользователи",
        home_org_environment: "Окружение",
        home_org_version: "Версия",
        home_license_kicker: "Лицензия",
        home_license_title: "Лимиты доступа",
        home_license_status: "Статус",
        home_license_usage: "Сотрудники",
        home_auth_required_title: "Войдите, чтобы продолжить",
        home_auth_required_text: "Рабочая область защищена. Войдите перед редактированием сотрудников, должностей и расписания.",
        home_auth_required_action: "Открыть вход",
        home_setup_auth_title: "Создайте доступ к организации",
        home_setup_auth_text: "Активных пользователей пока нет. Начните с создания или авторизации пользователя организации.",
        home_setup_auth_action: "Настроить доступ",
        home_setup_employees_title: "Добавьте команду",
        home_setup_employees_text: "Для расписания нужны сотрудники, иначе должности, пожелания и генерация не будут полезны.",
        home_setup_employees_action: "Открыть сотрудников",
        home_setup_positions_title: "Создайте должности",
        home_setup_positions_text: "Должности определяют, где люди могут работать и как разделяется расписание.",
        home_setup_positions_action: "Открыть настройки",
        home_setup_assignments_title: "Назначьте людей на должности",
        home_setup_assignments_text: "Генератор игнорирует сотрудников, которые не связаны с выбранной должностью.",
        home_setup_assignments_action: "Открыть назначения",
        home_setup_templates_title: "Создайте шаблоны смен",
        home_setup_templates_text: "Шаблоны описывают реальное время смен для ручного редактирования и автогенерации.",
        home_setup_templates_action: "Открыть шаблоны",
        home_setup_coverage_title: "Настройте правила покрытия",
        home_setup_coverage_text: "Правила покрытия говорят приложению, сколько сотрудников нужно в течение недели.",
        home_setup_coverage_action: "Открыть покрытие",
        home_setup_schedule_title: "Соберите расписание недели",
        home_setup_schedule_text: "Базовая настройка готова. Откройте расписание и заполните текущую неделю.",
        home_setup_schedule_action: "Открыть расписание",
        home_setup_review_title: "Проверьте текущую неделю",
        home_setup_review_text: "В рабочей области уже есть данные расписания. Проверьте покрытие и пожелания перед передачей.",
        home_setup_review_action: "Проверить расписание",
        home_load_error_title: "Не удалось прочитать рабочую область",
        home_load_error_text: "Обновите страницу или откройте расписание напрямую, если локальный API ещё запускается.",
        ...
        schedule_current_employee_badge: "Вы",
        shift_swap_section_label: "Обмен сменами",
        shift_swap_panel_title: "Заявки на обмен",
        shift_swap_title: "Запросить обмен смены",
        shift_swap_source_label: "Ваша смена",
        shift_swap_request_button: "Запросить обмен",
        shift_swap_short_button: "Обмен",
        shift_swap_no_candidates: "Нет доступных смен для обмена.",
        shift_swap_pick_target: "Выберите смену для обмена",
        shift_swap_already_pending: "уже ожидает решения",
        shift_swap_status_pending_target: "Ожидает сотрудника",
        shift_swap_status_pending_admin: "Ожидает утверждения",
        shift_swap_status_approved: "Утверждено",
        shift_swap_status_rejected: "Отклонено",
        shift_swap_status_cancelled: "Отменено",
        shift_swap_accept: "Согласиться",
        shift_swap_reject: "Отклонить",
        shift_swap_cancel: "Отменить",
        shift_swap_approve: "Утвердить",
        shift_swap_created: "Заявка на обмен отправлена.",
        shift_swap_updated: "Заявка на обмен обновлена.",
        shift_swap_create_failed: "Не удалось создать заявку на обмен.",
        shift_swap_update_failed: "Не удалось обновить заявку на обмен.",
        shift_swap_disabled: "Запросы на обмен сменами отключены.",
        schedule_other_positions_label: "Другие должности",
        schedule_delete_shift_btn: "Удалить",
        schedule_edit_shift_time: "Изменить время",
        schedule_time_btn: "Время",
        schedule_manual_time: "Время изменено",
        schedule_reset_template_time: "Сбросить к шаблону",
        ...
        confirm_impact_recurring_preferences: "Постоянные пожелания",
        ...
        msg_failed_save_shift_time: "Не удалось сохранить время смены.",
        msg_server_error_save_shift_time: "Ошибка сервера при сохранении времени смены.",
        ...
        generation_reason_cross_position_day: "работа в тот же день с другими должностями запрещена для одной из должностей",
        ...
        employees_permanent_preferences_title: "Постоянные пожелания",
        employees_permanent_preferences_hint: "Эти необязательные правила сохраняются для сотрудника и применяются каждую неделю.",
        employees_permanent_strict_title: "Постоянные строгие пожелания",
        employees_permanent_strict_text: "Генератор обязан строго учитывать эти пожелания.",
        ...
        msg_failed_load_permanent_preferences: "Не удалось загрузить постоянные пожелания.",
        msg_server_error_load_permanent_preferences: "Ошибка сервера при загрузке постоянных пожеланий.",
        msg_failed_save_permanent_preferences: "Не удалось сохранить постоянные пожелания.",
        ...
        preferences_request_modal_intro: "Выберите, какую просьбу сотрудник оставляет на этот день.",
        preferences_request_type: "Тип просьбы",
        preferences_request_shift: "Попросить смену",
        preferences_request_shift_hint: "Сотрудник хочет конкретную смену.",
        preferences_exclude_shift: "Исключить смену",
        preferences_exclude_shift_hint: "Эту смену лучше не ставить.",
        preferences_day_off_hint: "Полностью закрывает день для работы.",
        preferences_vacation_hint: "Сотрудник недоступен из-за отпуска.",
        preferences_request_shift_category: "Смена",
        preferences_request_category_hint: "Выберите точную смену, к которой относится просьба.",
        preferences_morning_hint: "Начало дня",
        preferences_evening_hint: "Вторая половина дня",
        preferences_night_hint: "Ночная смена",
        preferences_approval_title: "Подтверждение дополнительных просьб",
        preferences_approval_text: "Сотрудники могут сохранить просьбы на два дня напрямую. Дополнительные дни ожидают подтверждения здесь.",
        preferences_approval_empty: "Нет дополнительных просьб на подтверждение.",
        preferences_approve_request: "Подтвердить",
        preferences_reject_request: "Отклонить",
        preferences_delete_request: "Удалить",
        preferences_request_status_pending: "Ожидает подтверждения",
        preferences_request_status_approved: "Подтверждено",
        preferences_request_status_rejected: "Отклонено",
        ...
        preferences_note_4: "Сотрудники могут сохранять просьбы на два дня напрямую; дополнительные дни требуют подтверждения администратора.",
        ...
        msg_preference_change_saved_reload_failed: "Изменение сохранено, но обновить список не удалось:",
        msg_preference_deleted: "Пожелание очищено.",
        msg_preference_request_pending_approval: "Эта просьба отправлена администратору на подтверждение.",
        msg_preference_request_approved: "Просьба подтверждена.",
        msg_preference_request_rejected: "Просьба отклонена.",
        msg_preference_request_deleted: "Просьба удалена.",
        ...
        msg_server_error_delete_preference_request: "Ошибка сервера при удалении просьбы.",
        msg_server_error_load_preference_requests: "Ошибка сервера при загрузке заявок на пожелания.",
        departments_page_title: "Отделы",
        departments_page_subtitle: "Разделяйте команды, отделения и службы до создания должностей.",
        departments_default_name: "Основной отдел",
        departments_form_title: "Форма отдела",
        departments_form_subtitle: "Добавьте отделения или службы, чтобы должности не смешивались между командами.",
        departments_name: "Название отдела",
        departments_name_placeholder: "Пример: 1-е отделение",
        departments_description: "Описание",
        departments_description_placeholder: "Необязательная заметка",
        departments_display_order: "Порядок показа",
        departments_display_order_hint: "Меньшие числа показываются первыми в списках и селекторах.",
        departments_is_active: "Активный отдел",
        departments_add_button: "Добавить отдел",
        departments_update_button: "Обновить отдел",
        departments_reload_button: "Обновить",
        departments_list_title: "Список отделов",
        departments_list_subtitle: "Отделы, доступные для должностей и группировки расписания.",
        departments_table_id: "ID",
        departments_table_name: "Название",
        departments_table_description: "Описание",
        departments_table_order: "Порядок",
        departments_table_active: "Активен",
        departments_table_actions: "Действия",
        departments_empty_list: "Отделов пока нет",
        departments_empty_state_title: "Отделов пока нет",
        departments_empty_state_text: "Добавьте отдел перед созданием должностей внутри отделов.",
        departments_msg_enter_name: "Пожалуйста, введите название отдела.",
        departments_msg_failed_load: "Не удалось загрузить отделы.",
        departments_msg_server_error_load: "Ошибка сервера при загрузке отделов.",
        departments_msg_failed_save: "Не удалось сохранить отдел.",
        departments_msg_server_error_save: "Ошибка сервера при сохранении отдела.",
        departments_msg_editing: "Редактируется отдел",
        departments_msg_confirm_delete: "Удалить этот отдел?",
        departments_delete_blocked_hint: "Этот отдел нельзя удалить, пока должности не перенесены или пока не создан другой отдел.",
        departments_msg_failed_delete: "Не удалось удалить отдел.",
        departments_msg_server_error_delete: "Ошибка сервера при удалении отдела.",
        ...
        positions_department: "Отдел",
        positions_select_department: "Выберите отдел",
        ...
        positions_allow_same_day_other_positions: "Разрешить работу в тот же день с другими должностями",
        ...
        positions_table_department: "Отдел",
        positions_table_continuous: "Непрерывное покрытие",
        positions_table_min_presence: "Минимум присутствия",
        positions_table_same_day_other_positions: "Другие должности в тот же день",
        ...
        msg_select_department: "Пожалуйста, выберите отдел.",
        ...
        settings_tab_employee_portal: "Портал сотрудников",
        settings_tab_employee_portal_text: "Доступ сотрудников к расписанию",
        ...
        settings_departments_title: "Отделы",
        settings_departments_text: "Разделяйте отделения, службы и команды перед назначением должностей.",
        ...
        settings_employee_portal_title: "Портал сотрудников",
        settings_msg_loading_employee_portal: "Загрузка настроек портала сотрудников...",
        settings_msg_failed_load_employee_portal: "Не удалось загрузить настройки портала сотрудников. Повторите попытку.",
        settings_msg_saving_employee_portal: "Сохранение настроек портала сотрудников...",
        settings_employee_portal_text: "Управляйте тем, что сотрудники могут делать в портале сотрудников.",
        settings_save_employee_portal: "Сохранить настройки портала сотрудников",
        settings_shift_swap_enabled_title: "Запросы сотрудников на обмен сменами",
        settings_shift_swap_enabled_text: "Разрешить сотрудникам создавать новые заявки на обмен сменами из расписания.",
        settings_msg_failed_save_employee_portal: "Не удалось сохранить настройки портала сотрудников.",
        settings_msg_employee_portal_saved: "Настройки портала сотрудников сохранены.",
        ...
        settings_license_demo_text: "Демо-режим использует вымышленные тестовые данные. Генерация, экспорт и очистка расписаний доступны, а производственные настройки отключены.",
        ...
        demo_schedule_notice: "ShiftCare Demo использует вымышленные тестовые данные. Автогенерация, экспорт и очистка расписаний доступны; backup, cloud sync, обновления и активация лицензии отключены.",
        ...
        updates_modal_title: "Доступно обновление",
        updates_modal_text: "Доступна новая версия ShiftCare.",
        updates_modal_current_version: "Текущая версия",
        updates_modal_new_version: "Новая версия",
        updates_modal_later: "Позже",
        updates_modal_install: "Установить обновление",
        updates_modal_installing_title: "Установка обновления",
        updates_modal_installing_text: "Скачиваем инсталлятор обновления и готовим закрытие приложения.",
        updates_modal_install_error_title: "Не удалось запустить обновление",
        updates_modal_install_started_title: "Обновление запущено",
        updates_modal_install_started_text: "Инсталлятор запущен. ShiftCare скоро закроется.",
        updates_changelog_title: "Что изменилось",
        updates_changelog_text: "ShiftCare обновлён. Основные изменения в этой версии:",
        updates_changelog_empty: "Для этого релиза нет краткого списка изменений.",
        ...
        common_start_time: "Начало",
        common_end_time: "Конец",
        ...
        coverage_max_daily_work: "Максимальная длительность рабочего дня, минут",
    ...
    he: {
        ...
        nav_departments: "מחלקות",
        nav_requests: "העדפות",
        nav_settings: "הגדרות",
        nav_organization: "חשבון אישי",
        nav_feedback: "משוב",
        common_logout: "יציאה",
        ...
        home_title: "דף עבודה ראשי",
        home_subtitle: "מתחילים מהצעד התפעולי הבא, לא מעוד דשבורד.",
        ...
        home_next_kicker: "הצעד הבא",
        home_next_loading_title: "בודקים את סביבת העבודה",
        home_next_loading_text: "קוראים עובדים, תפקידים, תבניות, כללי כיסוי וסידור של השבוע הנוכחי.",
        home_next_action: "פתח סידור עבודה",
        home_week_kicker: "השבוע הנוכחי",
        home_week_title: "סט עבודה",
        home_metric_position: "תפקיד ראשי",
        home_metric_schedule_entries: "משמרות משובצות",
        home_metric_preferences: "העדפות",
        home_metric_coverage: "כללי כיסוי",
        home_primary_position_fallback: "עדיין אין תפקיד",
        home_actions_title: "קיצורי עבודה",
        home_ready_kicker: "מוכנות",
        home_ready_title: "רשימת בדיקה",
        home_readiness_employees: "עובדים",
        home_readiness_positions: "תפקידים",
        home_readiness_assignments: "שיוכים",
        home_readiness_templates: "תבניות משמרת",
        home_readiness_coverage: "כללי כיסוי",
        home_readiness_license: "רישיון",
        home_status_ready: "מוכן",
        home_status_attention: "דורש הגדרה",
        home_status_unknown: "לא ידוע",
        home_org_kicker: "סביבת עבודה",
        home_org_title: "סטטוס תפעולי",
        home_org_users: "משתמשים פעילים",
        home_org_environment: "סביבה",
        home_org_version: "גרסה",
        home_license_kicker: "רישיון",
        home_license_title: "מגבלות גישה",
        home_license_status: "סטטוס",
        home_license_usage: "עובדים",
        home_auth_required_title: "יש להתחבר כדי להמשיך",
        home_auth_required_text: "סביבת העבודה מוגנת. התחבר לפני עריכת עובדים, תפקידים וסידור עבודה.",
        home_auth_required_action: "פתח התחברות",
        home_setup_auth_title: "צור גישה לארגון",
        home_setup_auth_text: "עדיין אין משתמשים פעילים. התחל ביצירה או באישור של משתמש ארגון.",
        home_setup_auth_action: "הגדר גישה",
        home_setup_employees_title: "הוסף את הצוות",
        home_setup_employees_text: "סידור העבודה צריך עובדים לפני שתפקידים, העדפות ויצירה אוטומטית יהיו שימושיים.",
        home_setup_employees_action: "פתח עובדים",
        home_setup_positions_title: "צור תפקידים",
        home_setup_positions_text: "תפקידים מגדירים איפה עובדים יכולים לעבוד ואיך הסידור מחולק.",
        home_setup_positions_action: "פתח הגדרות",
        home_setup_assignments_title: "שייך עובדים לתפקידים",
        home_setup_assignments_text: "המחולל מתעלם מעובדים שאינם משויכים לתפקיד הנבחר.",
        home_setup_assignments_action: "פתח שיוכים",
        home_setup_templates_title: "צור תבניות משמרת",
        home_setup_templates_text: "תבניות מתארות את שעות המשמרת לעריכה ידנית וליצירה אוטומטית.",
        home_setup_templates_action: "פתח תבניות",
        home_setup_coverage_title: "הגדר כללי כיסוי",
        home_setup_coverage_text: "כללי הכיסוי אומרים למערכת כמה עובדים נדרשים לאורך השבוע.",
        home_setup_coverage_action: "פתח כיסוי",
        home_setup_schedule_title: "בנה את סידור השבוע",
        home_setup_schedule_text: "ההגדרה הבסיסית מוכנה. פתח את הסידור ומלא את השבוע הנוכחי.",
        home_setup_schedule_action: "פתח סידור עבודה",
        home_setup_review_title: "בדוק את השבוע הנוכחי",
        home_setup_review_text: "בסביבת העבודה כבר יש נתוני סידור. בדוק כיסוי והעדפות לפני שיתוף.",
        home_setup_review_action: "בדוק סידור",
        home_load_error_title: "לא ניתן לקרוא את סביבת העבודה",
        home_load_error_text: "רענן את הדף או פתח את הסידור ישירות אם ה-API המקומי עדיין עולה.",
        ...
        schedule_current_employee_badge: "את/ה",
        shift_swap_section_label: "החלפת משמרות",
        shift_swap_panel_title: "בקשות החלפה",
        shift_swap_title: "בקשת החלפת משמרת",
        shift_swap_source_label: "המשמרת שלך",
        shift_swap_request_button: "בקש החלפה",
        shift_swap_short_button: "החלפה",
        shift_swap_no_candidates: "אין משמרות זמינות לבקשת החלפה.",
        shift_swap_pick_target: "בחר משמרת לבקשת החלפה",
        shift_swap_already_pending: "כבר ממתין",
        shift_swap_status_pending_target: "ממתין לעובד",
        shift_swap_status_pending_admin: "ממתין לאישור מנהל",
        shift_swap_status_approved: "אושר",
        shift_swap_status_rejected: "נדחה",
        shift_swap_status_cancelled: "בוטל",
        shift_swap_accept: "אשר",
        shift_swap_reject: "דחה",
        shift_swap_cancel: "בטל",
        shift_swap_approve: "אשר סופית",
        shift_swap_created: "בקשת ההחלפה נשלחה.",
        shift_swap_updated: "בקשת ההחלפה עודכנה.",
        shift_swap_create_failed: "לא ניתן ליצור בקשת החלפה.",
        shift_swap_update_failed: "לא ניתן לעדכן בקשת החלפה.",
        shift_swap_disabled: "בקשות להחלפת משמרות כבויות.",
        schedule_other_positions_label: "תפקידים אחרים",
        schedule_delete_shift_btn: "מחק",
        schedule_edit_shift_time: "עריכת זמן",
        schedule_time_btn: "זמן",
        schedule_manual_time: "זמן ידני",
        schedule_reset_template_time: "איפוס לתבנית",
        ...
        confirm_impact_recurring_preferences: "העדפות קבועות",
        ...
        msg_failed_save_shift_time: "שמירת זמן המשמרת נכשלה.",
        msg_server_error_save_shift_time: "שגיאת שרת בזמן שמירת זמן המשמרת.",
        ...
        generation_reason_cross_position_day: "עבודה באותו יום עם תפקידים אחרים אינה מותרת באחד התפקידים",
        ...
        employees_permanent_preferences_title: "העדפות קבועות",
        employees_permanent_preferences_hint: "כללים אופציונליים שנשמרים לעובד ומופעלים בכל שבוע.",
        employees_permanent_strict_title: "העדפות קשיחות קבועות",
        employees_permanent_strict_text: "מחולל הסידור חייב לכבד את ההעדפות האלה.",
        ...
        msg_failed_load_permanent_preferences: "טעינת ההעדפות הקבועות נכשלה.",
        msg_server_error_load_permanent_preferences: "שגיאת שרת בזמן טעינת ההעדפות הקבועות.",
        msg_failed_save_permanent_preferences: "שמירת ההעדפות הקבועות נכשלה.",
        ...
        preferences_request_modal_intro: "בחר מה העובד מבקש ביום הנבחר.",
        preferences_request_type: "סוג בקשה",
        preferences_request_shift: "בקשת משמרת",
        preferences_request_shift_hint: "העדפה למשמרת מסוימת.",
        preferences_exclude_shift: "חסימת משמרת",
        preferences_exclude_shift_hint: "לא לשבץ במשמרת מסוימת.",
        preferences_day_off_hint: "חוסם עבודה לכל היום.",
        preferences_vacation_hint: "העובד אינו זמין בגלל חופשה.",
        preferences_request_shift_category: "משמרת",
        preferences_request_category_hint: "בחר את המשמרת המדויקת שאליה הבקשה מתייחסת.",
        preferences_morning_hint: "תחילת יום",
        preferences_evening_hint: "חלק מאוחר ביום",
        preferences_night_hint: "משמרת לילה",
        preferences_approval_title: "אישור בקשות נוספות",
        preferences_approval_text: "עובדים יכולים לשמור בקשות עבור שני ימים ישירות. ימים נוספים ממתינים כאן לאישור.",
        preferences_approval_empty: "אין בקשות נוספות שממתינות לאישור.",
        preferences_approve_request: "אשר",
        preferences_reject_request: "דחה",
        preferences_delete_request: "מחק",
        preferences_request_status_pending: "ממתין לאישור",
        preferences_request_status_approved: "אושר",
        preferences_request_status_rejected: "נדחה",
        ...
        preferences_note_4: "עובדים יכולים לשמור בקשות עבור שני ימים ישירות; ימים נוספים דורשים אישור מנהל.",
        ...
        msg_preference_change_saved_reload_failed: "השינוי נשמר, אך לא ניתן היה לרענן את הרשימה:",
        msg_preference_deleted: "ההעדפה נוקתה.",
        msg_preference_request_pending_approval: "הבקשה נשלחה לאישור מנהל.",
        msg_preference_request_approved: "הבקשה אושרה.",
        msg_preference_request_rejected: "הבקשה נדחתה.",
        msg_preference_request_deleted: "הבקשה נמחקה.",
        ...
        msg_server_error_delete_preference_request: "שגיאת שרת בזמן מחיקת הבקשה.",
        msg_server_error_load_preference_requests: "שגיאת שרת בזמן טעינת בקשות ההעדפה.",
        departments_page_title: "מחלקות",
        departments_page_subtitle: "הפרד צוותים, אגפים ושירותים לפני יצירת תפקידים.",
        departments_default_name: "מחלקה ראשית",
        departments_form_title: "טופס מחלקה",
        departments_form_subtitle: "הוסף אגפים או שירותים כדי שתפקידים יופרדו בצורה ברורה.",
        departments_name: "שם המחלקה",
        departments_name_placeholder: "לדוגמה: אגף 1",
        departments_description: "תיאור",
        departments_description_placeholder: "הערה אופציונלית",
        departments_display_order: "סדר תצוגה",
        departments_display_order_hint: "מספרים נמוכים יותר מופיעים ראשונים ברשימות ובבחירה.",
        departments_is_active: "מחלקה פעילה",
        departments_add_button: "הוסף מחלקה",
        departments_update_button: "עדכן מחלקה",
        departments_reload_button: "טען מחדש",
        departments_list_title: "רשימת מחלקות",
        departments_list_subtitle: "מחלקות זמינות לתפקידים ולקיבוץ סידור העבודה.",
        departments_table_id: "מזהה",
        departments_table_name: "שם",
        departments_table_description: "תיאור",
        departments_table_order: "סדר",
        departments_table_active: "פעילה",
        departments_table_actions: "פעולות",
        departments_empty_list: "אין עדיין מחלקות",
        departments_empty_state_title: "אין עדיין מחלקות",
        departments_empty_state_text: "הוסף מחלקה לפני יצירת תפקידים לפי מחלקה.",
        departments_msg_enter_name: "אנא הזן שם מחלקה.",
        departments_msg_failed_load: "טעינת המחלקות נכשלה.",
        departments_msg_server_error_load: "שגיאת שרת בזמן טעינת המחלקות.",
        departments_msg_failed_save: "שמירת המחלקה נכשלה.",
        departments_msg_server_error_save: "שגיאת שרת בזמן שמירת המחלקה.",
        departments_msg_editing: "עורך מחלקה",
        departments_msg_confirm_delete: "למחוק את המחלקה הזאת?",
        departments_delete_blocked_hint: "אי אפשר למחוק מחלקה זו עד שהתפקידים יועברו או שתיווצר מחלקה נוספת.",
        departments_msg_failed_delete: "מחיקת המחלקה נכשלה.",
        departments_msg_server_error_delete: "שגיאת שרת בזמן מחיקת המחלקה.",
        ...
        positions_department: "מחלקה",
        positions_select_department: "בחר מחלקה",
        ...
        positions_allow_same_day_other_positions: "אפשר עבודה באותו יום עם תפקידים אחרים",
        ...
        positions_table_department: "מחלקה",
        positions_table_continuous: "כיסוי רציף",
        positions_table_min_presence: "מינימום נוכחות",
        positions_table_same_day_other_positions: "תפקידים אחרים באותו יום",
        ...
        msg_select_department: "אנא בחר מחלקה.",
        ...
        settings_tab_employee_portal: "פורטל עובדים",
        settings_tab_employee_portal_text: "גישה של עובדים לסידור",
        ...
        settings_departments_title: "מחלקות",
        settings_departments_text: "הפרד אגפים, שירותים וצוותים לפני שיוך תפקידים.",
        ...
        settings_employee_portal_title: "פורטל עובדים",
        settings_msg_loading_employee_portal: "טוען הגדרות פורטל עובדים...",
        settings_msg_failed_load_employee_portal: "טעינת הגדרות פורטל העובדים נכשלה. נסה שוב.",
        settings_msg_saving_employee_portal: "שומר הגדרות פורטל עובדים...",
        settings_employee_portal_text: "נהל מה עובדים יכולים לעשות בפורטל העובדים.",
        settings_save_employee_portal: "שמור הגדרות פורטל עובדים",
        settings_shift_swap_enabled_title: "בקשות עובדים להחלפת משמרות",
        settings_shift_swap_enabled_text: "אפשר לעובדים ליצור בקשות חדשות להחלפת משמרות מתוך הסידור.",
        settings_msg_failed_save_employee_portal: "שמירת הגדרות פורטל העובדים נכשלה.",
        settings_msg_employee_portal_saved: "הגדרות פורטל העובדים נשמרו.",
        ...
        settings_license_demo_text: "מצב ההדגמה משתמש בנתונים בדויים. יצירה אוטומטית, ייצוא וניקוי סידורים זמינים, וכלי הגדרות ייצור נשארים מושבתים.",
        ...
        demo_schedule_notice: "ShiftCare Demo משתמש בנתונים בדויים. יצירה אוטומטית, ייצוא וניקוי סידורים זמינים; גיבוי, סנכרון ענן, עדכונים והפעלת רישיון מושבתים.",
        ...
        updates_modal_title: "עדכון זמין",
        updates_modal_text: "גרסה חדשה של ShiftCare זמינה.",
        updates_modal_current_version: "גרסה נוכחית",
        updates_modal_new_version: "גרסה חדשה",
        updates_modal_later: "מאוחר יותר",
        updates_modal_install: "התקן עדכון",
        updates_modal_installing_title: "מתקין עדכון",
        updates_modal_installing_text: "מוריד את מתקין העדכון ומכין את סגירת האפליקציה.",
        updates_modal_install_error_title: "לא ניתן להפעיל את העדכון",
        updates_modal_install_started_title: "העדכון הופעל",
        updates_modal_install_started_text: "המתקין הופעל. ShiftCare תיסגר בקרוב.",
        updates_changelog_title: "מה חדש",
        updates_changelog_text: "ShiftCare עודכנה. השינויים העיקריים בגרסה הזו:",
        updates_changelog_empty: "לא סופק תקציר שינויים לגרסה הזו.",
        ...
        common_start_time: "שעת התחלה",
        common_end_time: "שעת סיום",
        ...
        coverage_max_daily_work: "משך עבודה יומי מרבי, דקות",
