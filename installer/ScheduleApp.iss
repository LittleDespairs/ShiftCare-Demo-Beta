...
#define MyAppVersion "0.15.7-beta"
#define MyAppExeName "ShiftCare_0.15.7_beta.exe"
#define MyAppDistDir "..\dist\ShiftCare_0.15.7_beta"
...
VersionInfoProductVersion=0.15.7.0
