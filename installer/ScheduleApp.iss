...
#define MyAppVersion "0.15.5-beta"
#define MyAppExeName "ShiftCare_0.15.5_beta.exe"
#define MyAppDistDir "..\dist\ShiftCare_0.15.5_beta"
...
VersionInfoProductVersion=0.15.5.0
