...
#define MyAppVersion "0.15.8-beta"
#define MyAppExeName "ShiftCare_0.15.8_beta.exe"
#define MyAppDistDir "..\dist\ShiftCare_0.15.8_beta"
...
VersionInfoProductVersion=0.15.8.0
