...
#define MyAppVersion "0.17.2-beta"
#define MyAppExeName "ShiftCare_0.17.2_beta.exe"
#define MyAppDistDir "..\dist\ShiftCare_0.17.2_beta"
...
VersionInfoProductVersion=0.17.2.0
