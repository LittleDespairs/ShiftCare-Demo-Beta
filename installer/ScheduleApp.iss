...
#define MyAppExeName "ShiftCare_0.17.0_beta.exe"
#define MyAppDistDir "..\dist\ShiftCare_0.17.0_beta"
...
VersionInfoProductVersion=0.17.0.0
VersionInfoVersion=0.17.0.0
