...
#define MyAppVersion "0.14.8-beta"
#define MyAppExeName "ShiftCare_0.14.8_beta.exe"
#define MyAppDistDir "..\dist\ShiftCare_0.14.8_beta"
...
VersionInfoProductVersion=0.14.8.0
