...
#define MyAppVersion "0.14.6-beta"
#define MyAppExeName "ShiftCare_0.14.6_beta.exe"
#define MyAppDistDir "..\dist\ShiftCare_0.14.6_beta"
...
VersionInfoProductVersion=0.14.6.0
