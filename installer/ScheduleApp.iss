...
#define MyAppExeName "ShiftCare_0.15.2_beta.exe"
#define MyAppDistDir "..\dist\ShiftCare_0.15.2_beta"
...
VersionInfoProductVersion=0.15.2.0
VersionInfoVersion=0.15.2.0
