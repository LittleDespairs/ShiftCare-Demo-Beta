...
#define MyAppVersion "0.19.0-beta"
#define MyAppExeName "ShiftCare_Demo_0.19.0_beta.exe"
#define MyAppDistDir "..\dist\ShiftCare_Demo_0.19.0_beta"
...
VersionInfoProductVersion=0.19.0.0
