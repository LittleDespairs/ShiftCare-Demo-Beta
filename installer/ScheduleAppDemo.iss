...
#define MyAppExeName "ShiftCare_Demo_0.20.0_beta.exe"
#define MyAppDistDir "..\dist\ShiftCare_Demo_0.20.0_beta"
...
VersionInfoProductVersion=0.20.0.0
VersionInfoVersion=0.20.0.0
